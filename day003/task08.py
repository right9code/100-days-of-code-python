# LOGICAL OPERATORS
# A and B (Both have to be TRUE for it to be TRUE)
# C or D (Any one have to be TRUE for it to be TRUE)
...
if height >= 120:
    ...
    elif age >= 45 and age <= 55:# "and" operator checks for both greater than or equal to AND less than or equal to
        bill = 0
        print(f"Everything is going to be OKAY. Free ride on us!!")
    else:
        bill = 200
